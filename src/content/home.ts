export const homeSections = [
  ...
  { type: 'listening', title: 'What the flowers are listening to', body: 'The songs keeping us company in the garden lately. Press play and grow along.', playlistId: '37i9dQZF1DXcBWIGoYBM5M' },
